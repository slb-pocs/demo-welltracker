...
export class EquipmentInstalledViewComponent {
  ...
  PopulateTestScenario(){
    ...
    this.equipmentList=[
      {
        catalogNode:this.catalogNodeList[25],
        description:'',
        productNumber:this.catalogNodeList[25].id,
        serial:'2243266',
        deviation:56.87,
        md:67.87,
        tvd:678.987,        
      ...
      {
        catalogNode:this.catalogNodeList[15],
        description:'',
        productNumber:this.catalogNodeList[15].id,
        serial:'6754643',
        deviation:665.00,
        md:442.00,
        tvd:8790.00,        
